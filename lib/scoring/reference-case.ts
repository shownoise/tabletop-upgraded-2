...
// Team van 7: CRISIS_LEAD, SECURITY_LEAD, LEGAL_DPO, IT_LEAD, COMMS,
// FINANCE_PROC, BUSINESS_OWNER. RETAINER_LIAISON en HR onbezet → fallback naar
// SECURITY_LEAD / CRISIS_LEAD.
export const referenceExercise: ExerciseInput = {
  ...
  // R3 no-comment (slecht), R4 volledig (goed).
