...
<p style="color: #f85149; margin-top: 12px;">⚠ Do not reimage affected hosts before forensics. Contact your MDR immediately.</p>
      ...
      roleActions: [
        ...
        { id: "r1-a6", label: "Do nothing / wait for more information", description: "Gather more facts before acting. Ask IR retainer for initial assessment.", allowedRoles: [], irPlanAligned: true, consequence: "May be correct at this stage — avoids premature action. Risky if detection was already clear." },
      ],
    },
    {
      id: "r2",
...
<div style="margin-top: 8px; color: #888;">Recommended action: IMMEDIATELY isolate affected hosts</div>
      ...
      roleActions: [
        ...
        { id: "r2-a7", label: "Do nothing / wait for more information", description: "Gather more facts before acting. Request IR retainer assessment first.", allowedRoles: [], irPlanAligned: true, consequence: "Risky — encryption is actively in progress. Delay costs data." },
      ],
    },
    {
      id: "r3",
...
<p>Met vriendelijke groet,<br>Joris Vermeer<br>Redacteur Financieel Dagblad</p>
    ...
    },
    {
      ...
      roleActions: [
        { id: "r4-a1", label: "Authorize recovery from clean backups", description: "Formally authorize initiation of recovery from confirmed clean backups.", allowedRoles: ["it_manager", "system_admin", "ciso"], isRecommended: true, irPlanAligned: true },
        ...
        { id: "r4-a4", label: "Communicate impact to employees", description: "HR Lead sends internal communication to employees about incident impact and recovery timeline.", allowedRoles: ["hr_lead", "head_of_comms"], irPlanAligned: true },
        { id: "r4-a5", label: "Present financial impact to board", description: "Present financial impact analysis to the board of directors.", allowedRoles: ["cfo", "ceo"], irPlanAligned: true },
        { id: "r4-a6", label: "Resume all systems without full forensics", description: "Resume all systems immediately without completing forensic analysis.", allowedRoles: ["it_manager"], irPlanAligned: false, consequence: "Risk of reinfection if root cause not confirmed" },
        { id: "r4-a7", label: "Do nothing / wait for more information", description: "Delay all recovery actions pending further IR retainer guidance.", allowedRoles: [], irPlanAligned: true, consequence: "Extended downtime and customer impact. Regulatory deadline may pass." },
      ],
    },
  ],
  outcomes: {
